...
class Link(Base):
    ...
    # RESTRICT, not CASCADE: there's no user-delete endpoint yet, and hard-deleting a
    # user's links would contradict soft_delete()'s own reasoning that click rows must
    # keep a valid link_id to join against.
